...
export function TestimonialSection({ data }: TestimonialSectionProps): JSX.Element {
  return (
    <section className="relative flex overflow-hidden bg-white dark:bg-gray-900 px-4">
        ...
        <div className="w-full min-h-screen py-10">
          <div className="container mx-auto">
            ...
            <Link to="/testimonial" className="text-sm text-gray-500 dark:text-gray-300 py-4 block w-fit ml-auto hover:underline">See All -&gt;</Link>

...
import { PrismicDocumentProject } from "~/services/prismic";
...
import { getProjectPostLoader } from "~/services/prismic/projects";
...
export const loader: LoaderFunction = async (req) => {
  try {
    ...
    const data = await getProjectPostLoader(req.params.slug as string);
...
export default function BlogPost(): JSX.Element {
  ...
  return (
    ...
    >
      <header className="prose dark:prose-invert mx-auto px-4 mx:px-0 mb-5">
        <img
          src={d.image}
      ...
      <article className="prose  dark:prose-invert mx-auto px-4 mx:px-0">
